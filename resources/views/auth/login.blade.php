<x-guest-layout>
    ...
    <div class="h-screen grid grid-cols-5" style="background-image: url({{ asset('unsplash_UCbMZ0S-w28.png') }}); background-size: cover; background-position: center;">
        ...
        <div class="col-span-3 bg-[#131315]/50 flex justify-center items-center relative">
            ...
            <div class="absolute inset-x-0 bottom-0 m-[30px]">
                {{-- Get in touch --}}
        ...
        {{-- Right Side --}}
        <div class="col-span-2 bg-[#555585]/50 flex items-center relative p-20">
            <div class="flex-1">
                <h1 class="text-5xl font-bold text-white underline underline-offset-[12px] mb-14">Login</h1>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <!-- Username -->
                    <div class="mt-4">
                        <label for="name" class="text-2xl font-semibold text-white my-2">Username</label>
                    ...
                    <div class="block mt-4">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500  dark:focus:ring-offset-gray-800" name="remember">
                            <span class="ms-2 text-2xl font-semibold text-white">{{ __('Remember me') }}</span>
                        </label>
                    </div>

                    <button class="w-full mt-8 font-extrabold text-2xl rounded-lg h-[71px] bg-[#BEBEFF] text-white border-white border-2 hover:bg-[#fff]/90 hover:text-[#BEBEFF] hover:border-[#BEBEFF]">{{ __('Log in') }}</button>

                    <h3 class="text-2xl font-medium text-white mt-4 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-[#BEBEFF] font-extrabold">Register</a></h3>
                </form>
